    ...
    return (
        <div className="row d-flex justify-content-center">
            <div className="form-check col-5 d-flex justify-content-center">
                <input className="form-check-input" type="radio" name={name} id={ON} checked={isON} onChange={() => setIsON(true)} />
                <label className="form-check-label ms-2" htmlFor={ON}>
                    ON
                </label>
            </div>
            <div className="form-check col-5 d-flex justify-content-center">
                <input className="form-check-input" type="radio" name={name} id={OFF} onChange={() => setIsON(false)}/>
